...
import { BadRequestError, IAuthDocument, IEmailMessageDetails } from '@aprydatko/jobber-shared';
...
export async function forgotPassword(req: Request, res: Response): Promise<void> {
  ...
  if (!existingUser) {
    throw new BadRequestError('Invalid cridentials', 'Password forgotPassword() method error');
  }
